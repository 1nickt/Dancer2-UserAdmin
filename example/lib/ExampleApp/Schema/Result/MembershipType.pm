use utf8;
package ExampleApp::Schema::Result::MembershipType;
...
=head1 TABLE: C<membership_type>

=cut

__PACKAGE__->table("membership_type");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YKHoL+v8xvGdazTT8fjhBQ
